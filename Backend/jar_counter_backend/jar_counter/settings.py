...
ALLOWED_HOSTS = ['*','0.0.0.0', '127.0.0.1', 'localhost', '192.168.40.57', '3.21.185.97']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mydbcluster',  # Replace with your database name
        'USER': 'postgres',  # Replace with your RDS master username
        'PASSWORD': 't3n-bnutty',  # Replace with your RDS master password
        'HOST': 'mydbcluster.cpmemmykkgbl.us-east-2.rds.amazonaws.com',  # Replace with your RDS endpoint
